...
public class BaoCaoDoanhThuTheoNgay extends javax.swing.JFrame {
    ...
    private void updateT() {
        ...
        String sql = " Select sum(HoaDonNhap.ThanhTien),sum(HoaDonNhap.SoLuong), sum(HoaDonXuat.ThanhTien) ,sum(HoaDonXuat.SoLuong),sum(HoaDonXuat.ThanhTien)-Sum(HoaDonNhap.ThanhTien),getdate() from HoaDonNhap inner join HoaDonXuat on HoaDonNhap.MaMayTinh=HoaDonXuat.MaMayTinh";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            String sql = "Select sum(HoaDonNhap.ThanhTien),sum(HoaDonNhap.SoLuong), sum(HoaDonXuat.ThanhTien) ,sum(HoaDonXuat.SoLuong),sum(HoaDonXuat.ThanhTien)-Sum(HoaDonNhap.ThanhTien),getdate() from HoaDonNhap inner join HoaDonXuat on HoaDonNhap.MaMayTinh=HoaDonXuat.MaMayTinhlect Sum(HoaDonNhap.ThanhTien),sum(HoaDonNhap.SoLuong), sum(HoaDonXuat.ThanhTien),sum(HoaDonXuat.SoLuong),sum(HoaDonXuat.ThanhTien)-Sum(HoaDonNhap.ThanhTien) from HoaDonNhap inner join HoaDonXuat on HoaDonNhap.MaMayTinh=HoaDonXuat.MaMayTinh";
            pstN = connN.prepareStatement(sql);
        } catch (SQLException e) {
            JOptionPane.showConfirmDialog(null, e);
        }
