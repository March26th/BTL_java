 ...
 * @author Admin
 */
public class MayTinhSapHetHanSd extends javax.swing.JFrame {
      Connection connN = null;
    ResultSet rsN = null;
    DefaultTableModel dtN = null;
    PreparedStatement pstN = null;
    public MayTinhSapHetHanSd() {
        initComponents();
        setTitle("Máy Tính Sắp hết hạn sử dụng");
    ...
    private void updateH() {
        ...
        String sql = "select MayTinh.TenMayTinh,MayTinh.HanSD, DATEDIFF(day,GETDATE(),MayTinh.HanSD) from MayTinh where DATEDIFF(day,GETDATE(),MayTinh.HanSD)<90\n" +
"order by DATEDIFF(day,GETDATE(),MayTinh.HanSD) asc";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Máy Tính Sắp hết HSD ,đã hết hạn");
        ...
        jHSD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên Máy Tính", "Hạn Sử Dụng", "Số Ngày "
            }
        ));
